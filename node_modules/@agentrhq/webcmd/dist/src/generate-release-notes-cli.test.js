...
describe('runGenerateReleaseNotes', () => {
    ...
    it('swallows generator errors and keeps release-please notes intact', async () => {
        ...
        const exitCode = await runGenerateReleaseNotes(['node', 'script', 'v1.2.3'], { GEMINI_API_KEY: 'test-key' }, { loadContext }, io);
        expect(exitCode).toBe(0);
        expect(read()).toEqual({
            stdout: '',
    ...
    it('loads bounded PR diffs into release context', async () => {
        ...
        const context = await loadReleaseContext('v1.2.3', { GITHUB_REPOSITORY: 'acme/webcmd' }, { gh, maxDiffCharacters: 40 });
