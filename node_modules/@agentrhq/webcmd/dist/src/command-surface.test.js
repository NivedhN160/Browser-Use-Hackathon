...
import { CommanderStructuralError, coerceCommandArguments, configureCommandSurface, parseCommandSurface, parseOutputFormat, } from './command-surface.js';
const metadata = {
    command: 'demo/search',
    browser: false,
    defaultFormat: 'plain',
...
describe('parseCommandSurface', () => {
    ...
    it.each(['table', 'plain', 'json', 'yaml', 'yml', 'md', 'markdown', 'csv'])('accepts the %s output format', (format) => {
