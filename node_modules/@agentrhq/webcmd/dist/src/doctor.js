...
export async function runBrowserDoctor(opts = {}) {
    ...
    if (runtimeFlaky) {
        issues.push('Cloak runtime connection is unstable. The live browser test succeeded, but the daemon reported the runtime disconnected immediately afterward.\n' +
        ...
        if (health.state === 'profile-required') {
            ...
            issues.push('Daemon is running but the Cloak runtime is not connected.\n' +
