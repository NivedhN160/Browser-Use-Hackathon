    ...
    for (let attempt = 1; attempt <= TRANSPORT_MAX_ATTEMPTS; attempt++) {
        ...
        try {
            ...
            if (isDuplicateCommandId) {
                throw new BrowserCommandError('Daemon already has this command id pending; the command may already be running.', COMMAND_RESULT_UNKNOWN_CODE, COMMAND_RESULT_UNKNOWN_HINT);
            }
